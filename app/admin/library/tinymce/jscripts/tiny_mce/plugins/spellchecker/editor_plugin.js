	...
	tinymce.create('tinymce.plugins.SpellcheckerPlugin', {
		...
		init : function(ed, url) {
          ...
          cm;
            ...
            dataType: 'json',
            data: {
              text: t._getWords().join(' '),
              language: t.selectedLang
            },
            success: function(d) {
              
              var r = d.data.misspelledWords;
			...
			'+English=en,Spanish=es,French=fr,Hebrew=he,Italian=it,Latin=la,German=ge', 'hash'), function(v, k) {
				if (k.indexOf('+') === 0) {
					k = k.substring(1);
					t.selectedLang = v;
				}
